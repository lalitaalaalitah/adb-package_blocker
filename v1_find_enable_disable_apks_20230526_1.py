...
def find_n_disable_enable_apps(list_of_file_names_with_app_package_names, term_to_search_for, enable_or_disable, what_to_search, run_again):
    # 
    ...
    # run command file.
    if run_script_confirmation_bool:
    ...
    while run_again:
        ...
        if what_to_search == 's' or what_to_search == 'a':
            if term_to_search_for == "" and enable_or_disable == 'd':
                ...
                exit()
        find_n_disable_enable_apps(list_of_file_names_with_app_package_names, term_to_search_for, enable_or_disable, what_to_search, run_again)
        # 
